          ...
          {job && (
            <div className="max-w-5xl mx-auto px-4 py-8">
              ...
              <Card className="overflow-hidden shadow-lg border-2 mb-6">
                <div className="bg-gradient-to-r from-[#0B2551] to-[#00d2ff]/30 p-8 border-b border-white/10">
                    ...
                    <div className="flex items-center gap-3 p-4 rounded-lg border bg-background">
                      ...
                      <div>
                        ...
                        <p className="font-semibold">
                          {Math.round(Number(job.openings))}{" "}
                          {Math.round(Number(job.openings)) === 1
                            ? "position"
                            : "positions"}
                        </p>
                      </div>
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="p-2 border border-white/15 rounded-lg bg-white/[0.03] text-white"
              >
                  ...
                  >
                    ...
                    <div className="flex gap-2 pt-3 border-t">
                      <select
                        ...
                        className="flex-1 p-2 border border-white/15 rounded-lg bg-white/[0.03] text-white"
                      >
